...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'about', 'experience', 'education', 'publications', 'skills', 'contact', 'references'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-3">
                {[
                  "M. Kumar, B. Kumar, P. Sharma, R. Sharma, M. Al-Dhaifallah, and A. Shakoor, \"Attentive deep learning with randomized vector energy least square twin support vector machine for alzheimer's disease diagnosis,\" Computers and Electrical Engineering, vol. 126, p. 110 412, 2025.",
                  "R. Sharma, M. Al-Dhaifallah, and A. Shakoor, \"Fusenet: Attention-learning based mri–pet slice fusion for alzheimer's diagnosis,\" Computers and Electrical Engineering, vol. 127, p. 110 556, 2025.",
                  "R. Sharma, T. Goel, M. Tanveer, and M. Al-Dhaifallah, \"Alzheimer's disease diagnosis using ensemble of random weighted features and fuzzy least square twin support vector machine,\" IEEE Transactions on Emerging Topics in Computational Intelligence, vol. 9, no. 2, pp. 1281–1291, 2025.",
                  "M. Sajid, R. Sharma, I. Beheshti, M. Tanveer, and A. D. N. Initiative, \"Decoding cognitive health using machine learning: A comprehensive evaluation for diagnosis of significant memory concern,\" Wiley Interdisciplinary Reviews: Data Mining and Knowledge Discovery, vol. 14, no. 5, e1546, 2024.",
                  "M. Tanveer, T. Goel, R. Sharma, et al., \"Ensemble deep learning for alzheimer's disease characterization and estimation,\" Nature Mental Health, vol. 2, no. 6, pp. 655–667, 2024.",
                  "T. Goel, R. Sharma, M. Tanveer, P. Suganthan, K. Maji, and R. Pilli, \"Multimodal neuroimaging based Alzheimer's disease diagnosis using evolutionary RVFL classifier,\" IEEE Journal of Biomedical and Health Informatics, 2023.",
                  "R. Sharma, T. Goel, M. Tanveer, C. T. Lin, and R. Murugan, \"Deep-learning-based diagnosis and prognosis of alzheimer's disease: A comprehensive review,\" IEEE Transactions on Cognitive and Developmental Systems, vol. 15, no. 3, pp. 1123–1138, 2023.",
                  "S. Verma, T. Goel, M. Tanveer, W. Ding, R. Sharma, and R. Murugan, \"Machine learning techniques for the Schizophrenia diagnosis: A comprehensive review and future research directions,\" Journal of Ambient Intelligence and Humanized Computing, 2023.",
                  "S. Dwivedi, T. Goel, M. Tanveer, R. Murugan, and R. Sharma, \"Multi-modal fusion based deep learning network for effective diagnosis of Alzheimers disease,\" IEEE MultiMedia, 2022.",
                  "R. Sharma, T. Goel, M. Tanveer, P. Suganthan, I. Razzak, and R. Murugan, \"Conv-ERVFL: Convolutional neural network based ensemble RVFL classifier for Alzheimer's disease diagnosis,\" IEEE Journal of Biomedical and Health Informatics, 2022.",
                  "R. Sharma, T. Goel, M. Tanveer, and R. Murugan, \"FDN-ADNet: Fuzzy LS-TWSVM based deep learning network for prognosis of the Alzheimer's disease using the sagittal plane of MRI scans,\" Applied Soft Computing, vol. 115, p. 108 099, 2022.",
                  "R. Sharma, T. Goel, M. Tanveer, S. Dwivedi, and R. Murugan, \"FAF-DRVFL: Fuzzy activation function based deep random vector functional links network for early diagnosis of Alzheimer disease,\" Applied Soft Computing, vol. 106, p. 107 371, 2021."
                ].map((pub, idx) => (
                  <div key={idx} className="bg-white p-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border-l-4 border-blue-500">
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  "K. Maji, R. Sharma, S. Verma, and T. Goel, \"Rvfl classifier based ensemble deep learning for early diagnosis of Alzheimer's disease,\" in Neural Information Processing, M. Tanveer, S. Agarwal, S. Ozawa, A. Ekbal, and A. Jatowt, Eds., Cham: Springer International Publishing, 2023, pp. 616–626.",
                  "M. Tanveer, S. Verma, R. Sharma, T. Goel, and P. N. Suganthan, \"Weighted kernel ridge regression based randomized network for Alzheimer's disease diagnosis using susceptibility weighted images,\" in 2023 International Joint Conference on Neural Networks (IJCNN), 2023, pp. 1–8.",
                  "R. Sharma, T. Goel, and R. Murugan, \"An optimized deep learning network for prognosis of Alzheimer's disease using structural magnetic resonance imaging,\" in 2022 IEEE 10th Region 10 Humanitarian Technology Conference (R10-HTC), 2022, pp. 203–207.",
                  "R. Sharma, T. Goel, and R. Murugan, \"Prediction of Alzheimer's disease using machine learning algorithm,\" in Proceedings of the International Conference on Computational Intelligence and Sustainable Technologies, Springer, 2022, pp. 11–17.",
                  "S. Dwivedi, T. Goel, R. Sharma, and R. Murugan, \"Structural MRI based Alzheimer's disease prognosis using 3D convolutional neural network and support vector machine,\" in 2021 Advanced Communication Technologies and Signal Processing (ACTS), 2021, pp. 1–4."
                ].map((pub, idx) => (
                  <div key={idx} className="bg-white p-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border-l-4 border-green-500">
                    <p className="text-slate-700 leading-relaxed text-sm">{pub}</p>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-6 rounded-lg shadow-lg border-l-4 border-orange-600">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <ul className="space-y-3 text-slate-600">
                  <li className="flex items-start gap-2">
                    <Award className="text-green-600 mt-1 flex-shrink-0" size={18} />
                    <span><strong>2025:</strong> Delivered Expert Talk along with Hand-on session in Deep Learning and its Applications in 5-Days Workshop at The LNMIIT Jaipur</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Award className="text-blue-600 mt-1 flex-shrink-0" size={18} />
                    <span><strong>2022:</strong> Active organizer of various High-End Workshops and events</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Award className="text-orange-600 mt-1 flex-shrink-0" size={18} />
                    <span><strong>2022:</strong> Delivered Expert Talk along with Hand-on session in MATLAB in various High-End Workshops</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <ul className="space-y-3 text-slate-600">
                  <li className="flex items-start gap-2">
                    <Award className="text-blue-600 mt-1 flex-shrink-0" size={18} />
                    <span><strong>Data Science Masters</strong> from PWskills (2023)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Award className="text-blue-600 mt-1 flex-shrink-0" size={18} />
                    <span><strong>IEEE CIS Summer School</strong> on Deep Learning and Computational Intelligence: Theory and Applications, IIT Indore (December 12-16, 2022)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Award className="text-blue-600 mt-1 flex-shrink-0" size={18} />
                    <span><strong>IEEE International Workshop</strong> on Optimization and Intelligence in Electronics Engineering Applications (July 26-30, 2021)</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section id="references" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-slate-900">References</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-slate-900">Dr. Tripti Goel</h3>
                  <p className="text-blue-700 font-semibold">Assistant Professor</p>
                </div>
              </div>
              <div className="space-y-2 text-slate-700">
                <p className="font-semibold">Department of Electronics and Communications Engineering</p>
                <p>National Institute of Technology Silchar</p>
                <p>Assam, 788010, India</p>
                <a
                  href="mailto:triptigoel@ece.nits.ac.in"
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-slate-900">Dr. M Tanveer</h3>
                  <p className="text-green-700 font-semibold">Associate Professor</p>
                </div>
              </div>
              <div className="space-y-2 text-slate-700">
                <p className="font-semibold">Department of Mathematics</p>
                <p>Indian Institute of Technology Indore</p>
                <p>Khandwa Road, Simrol, Indore (M.P.)</p>
                <p>India 453552</p>
                <a
                  href="mailto:mtanveer@iiti.ac.in"
